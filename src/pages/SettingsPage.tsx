    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 bg-slate-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Avvisi push il giorno della scadenza alle 9:15</p>
            </div>
          </div>
          {/* Enable toggle */}
          <button
          ...
          {loading ? (
            ...
            <>
              ...
              <div className={`flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium w-fit ${
                ...
                {enabled && userKey && apiToken
                  ? <><Bell size={13} /> Notifiche attive — ogni giorno alle 9:15 (ora italiana estiva)</>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
        ...
        <ol className="text-sm text-slate-600 space-y-2 list-none">
          {[
            'Ogni mattina alle 9:15 il sistema verifica se ci sono spese con data di scadenza uguale ad oggi e stato "Da pagare".',
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-3">
          <p className="text-xs text-amber-800">
            <strong>Nota sull'orario:</strong> Le notifiche automatiche sono programmate alle 7:15 UTC, che corrisponde alle <strong>9:15 ora italiana estiva</strong> (CEST, UTC+2).
            In inverno (CET, UTC+1) l'arrivo si sposta alle 8:15.
          </p>
        </div>
      </div>
    </div>
